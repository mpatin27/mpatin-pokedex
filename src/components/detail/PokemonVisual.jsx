    ...
    <div className="holo-card">
      ...
      {showToast && (
        <div className="toast-notification">
          {/* Petite icône Check intégrée */}
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#48bb78" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
